...
execute if score $snow_blocks skyvoid_vanilla_oneblock matches 23.. store success score $starter_done skyvoid_vanilla_oneblock run gamerule advance_weather true
