...
execute as @e[type=zombie,tag=!skyvoid_vanilla_oneblock_hostile] run data merge entity @s {Tags:["skyvoid_vanilla_oneblock_hostile"],DeathLootTable:"skyvoid_vanilla_oneblock_starter:starter_zombie",HandItems:[{id:"iron_shovel",count:1b},{}],drop_chances:{mainhand:0.0f}}
